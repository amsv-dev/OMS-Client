...
| `runtime-smoke.sh` | Gate pós-install/update — agent/console/telegraf + **auth Influx** (exit 0/1). Vault selado = aviso; Influx 401 → falha com remediação `reset-client.sh --runtime` |
